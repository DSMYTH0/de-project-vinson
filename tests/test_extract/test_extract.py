...
from src.extract.extract import (extract_handler, fetch_table_names,
                                 get_last_extracted_time, update_extracted_time,
                                 extract_data, put_csv)
...
class TestUtilFunctions:
    ...
    def test_function_returns_expected_dataframe(self, s3_client, s3_bucket):
        bucket = "vinson-ingestion-zone"
        current_date = "2024-08-19 15:04:40.584900+00:00"
            
        
        with patch('src.extract.extract.connect_to_db') as mock_connection:
            with patch('src.extract.extract.get_last_extracted_time') as mock_extract_time:
                with patch('src.extract.extract.update_extracted_time') as mock_update_time:
                    ...
                    mock_update_time.assert_called_once_with(bucket, "staff", current_date, ANY)
